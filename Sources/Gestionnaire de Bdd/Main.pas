...
begin
  ...
  stringUsers := '_id,mail,password,firstName,lastName,nickName,isSeller,shopName,shopCity,shopStreet,shopNum,shopPostalCode,shopkind,shopTags,contacts,téléphone,shopLongitude,shopLatitude,__v';
