...
begin
  ...
  stringUsers := '_id,mail,password,firstName,lastName,nickName,isSeller,__v,contacts,téléphone,shopCity,shopDescription,shopkind,shopLatitude,shopLongitude,shopName,shopNum,shopPostalCode,shopStreet';
  stringProducts :='id,shopId,name,price,tags,type,__v';
end;
//------------------------------------------------------------------------------
...
begin
  ...
  try
    ...
    begin
      ...
      tableauDonnees.ColCount := ListHeader.Count+1;
